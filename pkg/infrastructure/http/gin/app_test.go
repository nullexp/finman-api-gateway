...
import (
	...
	mlp "github.com/nullexp/finman-gateway-service/pkg/infrastructure/http/protocol/model/multipart"
	"github.com/nullexp/finman-gateway-service/pkg/infrastructure/http/protocol/model/openapi"
	"github.com/nullexp/finman-gateway-service/pkg/infrastructure/http/protocol/utility"
...
func (t *TestDto) Validate(context.Context) error {
	if t.Id != Id {
...
func (*anotherDto) Validate(context.Context) error {
	return nil
}
